...
Die Zahlen aus der Vertriebsforschung dazu sind unangenehm deutlich. Wer innerhalb der ersten fünf Minuten reagiert, qualifiziert eine Anfrage rund 21-mal häufiger als jemand, der erst nach einer halben Stunde antwortet. Nicht ein bisschen häufiger.
...
Ich habe mir 37 Maklerbüros in der Oberpfalz angesehen. Bei keinem einzigen bekommt eine Anfrage automatisch eine Reaktion. Bei keinem.

Das ist kein Versäumnis einzelner Büros. Das Problem ist strukturell. Die Anfrage trifft genau dann ein, wenn du das tust, wofür dich der Kunde bezahlt: beim Termin sein, ein Objekt aufnehmen, verhandeln. In dem Moment gehst du nicht ans Telefon, und das ist auch richtig so. Wer den ganzen Tag am Schreibtisch sitzt, ist kein guter Makler.
...
Das ist der Merak-Effekt: nicht mehr Arbeit in weniger Zeit, sondern ein Feierabend, an dem nichts mehr offen ist.
