...
> - **2026-06-19 — Kontakt redesign**: form-only page + `ContactSuccess` confirmation; scheduler dropped (component kept). Spec/plan: `docs/superpowers/{specs,plans}/2026-06-19-kontakt-redesign*`.
