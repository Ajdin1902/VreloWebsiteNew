...
> - **2026-06-24 — „Die Termin-Quelle“ flagship on /leistungen** (deployed): new **`TerminQuelleAngebot`** petrol-band featured block lifts the packaged speed-to-lead offer above the generic menu (now reframed „Die einzelnen Bausteine“); **price-free** + calm founding-promise note; copy in `src/lib/termin-quelle.ts` (source of truth: HQ `Knowledge/Offers/Termin-Quelle.md`). Design-system note + AA trap above. Commits 4ec0080…f393172.
...
> - **2026-06-23 — Cal.com scheduler LIVE + Kontakt/Newsletter polish**: scheduler on-dark above the Kontakt form (EU `cal.eu` origin — see *Gotchas*); ripple banner closes on papier; eased the `WaterSection` top pull. Git has the detail.
