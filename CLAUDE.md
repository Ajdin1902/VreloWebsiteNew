...
> - **2026-06-15/16 — landing-page + centered-spine**: homepage re-laid on a centered spine with the full-bleed flowing-water hero (`hero-flow.webp`); `Was ich baue` image + `GeschichteTeaser` dropped; Hormozi-filtered copy (`Knowledge/marketing/{LANDING_PAGE,HOOKS}.md`), pain/hours H1, CTA → „Zeit zurückgewinnen“. (Details in *Key decisions* + *design system*.)
