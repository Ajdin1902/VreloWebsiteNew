...
3. **Remove the eyebrow/kicker labels above all headlines** (site-wide, founder 2026-06-19) — the small uppercase tracked label above page/section headings (`PageIntro` `eyebrow`, e.g. „Kontakt“/„Leistungen“, plus any section eyebrows). Drop the labels + their now-unused props/styles, then browser-verify. (Also a known AI-design tell.)
