...
Project memory for building the **Vrelo** website. This file is the working brand brief, distilled from the canonical brand docs. When brand/design/copy decisions arise, follow this; the full source of truth lives in `C:\Users\ajdin\OneDrive\AJ19\ADZ\Brand\` (`Vrelo-Brand.md`, `vrelo-brand-voice.md`, `vrelo-brand-cheatsheet.md`, `vrelo-brand-summary.md`).
...
Assets in `C:\Users\ajdin\OneDrive\AJ19\ADZ\Brand\Vrelo Brand Project\assets\` (copy into project as needed):
...
## 7. Tech stack
_Not yet chosen — to be decided with the user before building._ (Greenfield project; working dir is empty.)
