...
export function MerakClose() {
  return (
    <Section tone="warm" className="relative overflow-hidden">
      ...
      />
      <Reveal as="h2" delayMs={0} className="max-w-2xl font-serif text-3xl italic leading-snug text-ember md:text-4xl">
        Stell dir den Montagmorgen vor, an dem schon zwei Stunden Arbeit erledigt sind.
      </Reveal>
      <Reveal as="p" delayMs={80} className="mt-6 max-w-xl text-lg text-tinte">
