  ...
  return (
    <Section tone="petrol">
      ...
      <Reveal delayMs={320} className="mt-8 block">
        <Link
          href="/leistungen"
          className="inline-block rounded-sm font-medium text-honig underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-vrelo-petrol focus-visible:ring-honig"
        >
