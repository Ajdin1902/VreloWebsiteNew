...
// homepage-hero treatment), followed by an optional long lead on paper. The image
// is decorative (alt=""), so the H1 carries the page's meaning. A soft text-shadow
...
export function PageHero({
  ...
  return (
    <>
      ...
      {/* The lead: a Fraunces serif standfirst (a magazine deck, responsive:
          ~1.25rem → 1.6rem) on a paper band, with a drop-cap initial sized in `em`
          so it scales with the responsive text (navy text + petrol cap). Deck stays
